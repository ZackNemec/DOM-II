const yellowNav = document.querySelector(".nav");
yellowNav.addEventListener("mouseenter", () => {
  yellowNav.style.transform = "scale(1.2)";
});
yellowNav.addEventListener("mouseleave", () => {
  yellowNav.style.transform = "scale(1)";
});
